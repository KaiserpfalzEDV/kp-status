...
/**
 * Event that the application event bus is about to be closed and all registered listeners will be unregistered automatically by the bus.
 * 
...
public class ApplicationEventBusCloses extends BaseEventImpl<ApplicationEventBus> {
}
