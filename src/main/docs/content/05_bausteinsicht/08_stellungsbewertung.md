...
### Schnittstellen
Das Modul stellt seine Funktionalität über die Schnittstelle _de.kp-status.engine.bewertung.Bewertung_ bereit, _de.kp-status.engine.bewertung.ReineMaterialBewertung_ ist eine sehr einfache Implementierung.
...
### Ablageort / Datei
Die Implementierung liegt unterhalb der Pakete _de.kp-status.engine.bewertung..._
...
Hier ist viel Spielraum für Verbesserungen, der bewusst nicht ausgeschöpft wurde, da kp-status ja zum Experimentieren einladen soll.
