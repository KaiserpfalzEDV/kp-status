...
Die Klassen und Aufzählungstypen (enums) befinden sich im Paket _de.kp-status.allgemein_.

Eine Schachfigur ist gekennzeichnet durch Farbe (schwarz oder weiß) und Art (König, Dame, ...).
Im Domänenmodell von kp-status weiß eine Figur nicht, wo sie steht.
